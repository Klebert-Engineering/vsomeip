...
#ifdef ANDROID
    read_android_internal_data(its_input, its_mandatory_elements, its_failed);
#else
...
"}";
        ...
        boost::property_tree::json_parser::read_json(conf_stream, its_tree);
        _elements.push_back({ "/storage/internal_vsomeip_conf.json", its_tree });
    }
    catch (boost::property_tree::json_parser_error &e) {
        _failed.insert("/storage/internal_vsomeip_conf.json");
    }
}
